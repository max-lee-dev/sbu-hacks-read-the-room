...
export default function WarningsPage() {
  ...
  const checkboxId = useId();
    ...
    // Auto-redirect if user has set preference
    useEffect(() => {
        ...
        <main className="flex-1 overflow-y-auto px-4 pb-24 flex flex-col items-center">
          ...
          <section className="w-full rounded-2xl border border-black bg-white p-6 shadow-sm" style={{ backgroundColor: '#2D2D2D', border: '1px solid #404040' }}>
            <div className="mb-6 flex flex-col items-center text-center">
              <h2 className="text-2xl font-bold" style={{ color: '#FFFFFF' }}>How Room Reader Works</h2>
              <p className="mt-2 text-sm" style={{ color: '#B0B0B0' }}>
                Get AI-powered insights to improve your social awareness
              </p>
            </div>
              ...
              <li className="flex flex-col items-center text-center">
                <div className="flex flex-col items-center">
                  <div className="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" style={{ color: '#E0E0E0' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                    </svg>
                    <h3 className="text-lg font-semibold" style={{ color: '#FFFFFF' }}>Record the Room</h3>
                  </div>
              ...
              <li className="flex flex-col items-center text-center">
                <div className="flex flex-col items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-lg font-semibold" style={{ color: '#FFFFFF' }}>AI Anaylsis</h3>
                  </div>
                  <p className="mt-3 text-sm" style={{ color: '#B0B0B0' }}>
              ...
              <li className="flex flex-col items-center text-center">
                <div className="flex flex-col items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-lg font-semibold" style={{ color: '#FFFFFF' }}>Get Insights</h3>
                  </div>
                  <p className="mt-3 text-sm" style={{ color: '#B0B0B0' }}>
            ...
            {/* Warning Box */}
            <div className="mt-6 rounded-xl p-4 text-sm text-center" style={{ border: '1px solid #EF4444', backgroundColor: 'rgba(239, 68, 68, 0.1)' }}>
              <div className="mb-2 flex items-center justify-center gap-2 font-semibold" style={{ color: '#EF4444' }}>
